<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Edit a user') }}</flux:subheading>
    ...
    <div>
        <form wire:submit="submit">
            ...
            <flux:button type="submit" class="mt-4 cursor-pointer" variant="primary">Edit User</flux:button>
        </form>
    </div>
</div>
